...
func (_mock *MockPublisher) Publish(ctx context.Context, msg []byte) error {
...
func (_c *MockPublisher_Publish_Call) Run(run func(ctx context.Context, msg []byte)) *MockPublisher_Publish_Call {
...
func (_c *MockPublisher_Publish_Call) RunAndReturn(run func(ctx context.Context, msg []byte) error) *MockPublisher_Publish_Call {
	_c.Call.Return(run)
	return _c
}
